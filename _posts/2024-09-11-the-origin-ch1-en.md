...
lang: en
description: A gloomy rainy night, an "abandoned" robot and a human.
---

<!-- prettier-ignore-start -->
> Artificial Intelligence technology ([DeepL Write](https://www.deepl.com/write)) is used during the creation of this article.
{: .prompt-info }
<!-- prettier-ignore-end -->
...
"So that means... I was _outside_ before?" I lean my cube-shaped head back against the wall.
...
"I don't think I can say _no_, can I?" It actually makes me a little excited to have a name, a name like a human.
...
"How about _Mico_? M-i-c-o? It looks just like your model number."
